...
class _ProfileWidgetState extends State<ProfileWidget> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        ElevatedButton(
                child: Text(
                  "Logout",
                  style: TextStyle(color: Colors.black,  fontSize: 16,   fontFamily: 'Lexend Deca',),
                ),
  ...
  FlutterFlowIconButton({required Color borderColor, required int borderRadius, required int buttonSize, required Icon icon, required Future<Null> Function() onPressed}) {}
